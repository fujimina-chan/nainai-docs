...
│   ├── settings.md                    # アプリ共通 Settings 基盤（Category / Tooltip / Launcher 等）
...
| [settings.md](design/settings.md) | アプリ共通 Settings 基盤（Category / Tooltip ON/OFF、Settings Launcher 配置等） |
...
| [development-environment.md](architecture/development-environment.md) | Windows リポジトリ配置・開発環境 Known Issue |
